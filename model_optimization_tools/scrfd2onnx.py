...
def pytorch2onnx(config_path,
                 ...
                 opset_version=11,
                 show=False,
                 output_file='./scrfd_500m_bnkps_test_widerface_latest',
                 verify=False,
                 simplify = False,
                 dynamic = True,
                 normalize_cfg=None,
    ...
    if simplify or dynamic:
        ori_output_file = output_file + "_ori.onnx"
    else:
    ...
    if dynamic:
        ...
        dynamic_axes = {out: {1: '?'} for out in output_names}
